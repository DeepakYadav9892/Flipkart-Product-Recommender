...
- **Clone your GitHub repo**
  ...
  ```bash
  gh repo clone DeepakYadav9892/Flipkart-Product-Recommender
...
```bash
git config --global user.email "deepak989241@gmail.com"
git config --global user.name "DeepakYadav9892"
